    ...
    <div class="slidePanel-actions" aria-label="actions" role="group">
      ...
      <div class="btn-group actions-bottom" role="group">
        <div class="float-left" style="position:relative;">
          <button type="button" class="btn btn-icon btn-pure btn-inverse icon wb-more-horizontal" data-toggle="dropdown" aria-expanded="false" aria-hidden="true"></button>
      ...
      <div class="mail-header">
        <div class="mail-header-main">
          ...
          <div><a href="javascript:void(0)">Mazhesee@gmail.com</a> to <a href="javascript:void(0)">me</a>
            <span class="identity"><i class="icon wb-medium-point red-600" aria-hidden="true"></i>Work</span>
          </div>
        </div>
